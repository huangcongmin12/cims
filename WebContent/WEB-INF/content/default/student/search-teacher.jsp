					...
					<div class="row">
						...
						<fieldset>
							...
							<form id="login" name="form"
								action="${pageContext.request.contextPath }/student/search-teacher.html"
								method="post" class="">
								<div class="span8 ">
									<div class="grid">
										<div class="row">
													...
													<div class="row">
														...
														<div class="span2">
															<div class="input-control select">
																<select id="teacherNumber" name="teacherNumber">
																	<option value="">--选择--</option>
																	<c:forEach items="${teacherList }" var="teacher">
																		<option value=${teacher.teacherNumber }>${teacher.teacherNumber }</option>
																	</c:forEach>
																</select>
															</div>
														</div>
