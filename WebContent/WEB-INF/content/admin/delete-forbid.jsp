...
<div class="page secondary with-sidebar">
	...
	<div class="page-region ">
		<div class="page-region-content">
			<fieldset>
					 <p class="tertiary-info-secondary-text "> <h4> <span class="fg-color-red"><i class="icon-cancel fg-color-red"></i>对不起，您无权删除！</span></h4> </p>
					 <br><span> <a href="" onclick="javascript:history.go(-1);return false;"><i class="icon-arrow-left-3 "></i>返回列表</a></span>
			</fieldset>
		</div>
	</div>
</div>
