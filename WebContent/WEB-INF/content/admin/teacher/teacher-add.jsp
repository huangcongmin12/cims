	...
	<div class="page-region ">
		<div class="page-region-content">
			<div style="text-align: center;">
				<h3><small>添加教师用户</small></h3>
			</div>
			<a class="button mini bg-color-blue fg-color-white" href="${pageContext.request.contextPath }/admin/teacher-list.html"><i class="icon-arrow-left-3 "></i>返回列表</a>
			<c:if test="${!empty errorMsg }">
					<div><fieldset><font color="red" size='2'>${errorMsg }</font></fieldset></div>
			</c:if>
			<fieldset>
				<form action="${pageContext.request.contextPath }/admin/teacher-add.html" method="post">
					<table style="width: 84%">
						<tbody>
							...
							<tr>
								...
								<td><label onclick="" class="input-control radio">
										<input type="radio" checked="" name="teacher.status" value="0" />
