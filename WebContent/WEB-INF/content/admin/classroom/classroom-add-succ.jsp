...
<div class="page secondary with-sidebar">
	...
	<div class="page-region ">
		<div class="page-region-content">
			...
			<fieldset>
					 <p class="tertiary-info-secondary-text "> <h4> <span class="fg-color-green"><i class="icon-checkmark fg-color-green"></i>新增成功！</span></h4> </p>
					</table>
				</form>
			</fieldset>
		</div>
...
<%
	String url = "classroom-list.html";
